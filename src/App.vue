<template>
  ...
  <div class="max-w-7xl mx-auto flex flex-col relative">
    ...
    <nav class="max-w-7xl px-5 top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-2xl text-[#00C9FF] font-semibold whitespace-nowrap fadein-bot hover:text-[#92FE9D]">0xPrinz</span>
        </button>

        <div class="flex md:order-2 fadein-bot">
          <a href="https://www.tiktok.com/@0xprinz">
            <img class="w-9 rounded-full" src="https://images.rawpixel.com/image_png_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvdjk4Mi1kNS0wOC5wbmc.png" />
          </a>
        </div>
...
@keyframes shadowGradient {
  0% {
    box-shadow: 0px 0px 10px 2px rgba(0, 201, 255, 0.8);
  }
  100% {
    box-shadow: 0px 0px 20px 5px rgba(146, 254, 157, 0.8);
  }
}

img.w-9:hover {
  animation: shadowGradient 1s linear infinite alternate;
  transition: box-shadow 0.3s ease;
}

img.w-9 {
  transition: box-shadow 0.3s ease; /* ensures smooth transition when not hovered */
}
